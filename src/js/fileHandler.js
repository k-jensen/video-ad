const subtitlesDragDrop = require('drag-drop')
const descriptionsDragDrop = require('drag-drop')
const videoDragDrop = require('drag-drop')
 
// You can pass in a DOM node or a selector string!
subtitlesDragDrop('.subtitles', (files, pos, fileList, directories) => {
  ...
  files.forEach(file => {
    ...
    document.getElementById('subtitles').src = window.URL.createObjectURL(file);
...
// You can pass in a DOM node or a selector string!
descriptionsDragDrop('.descriptions', (files, pos, fileList, directories) => {
    console.log('Here are the dropped files', files)
    console.log('Dropped at coordinates', pos.x, pos.y)
    console.log('Here is the raw FileList object if you need it:', fileList)
    console.log('Here is the list of directories:', directories)
    ...
    files.forEach(file => {
      ...
      document.getElementById('descriptions').src = window.URL.createObjectURL(file);
      // console.log(file.readUInt32LE(0))
      // console.log(file.toJSON())
      // console.log(file.toString('hex')) // etc...
  ...
  // You can pass in a DOM node or a selector string!
videoDragDrop('.video', (files, pos, fileList, directories) => {
    console.log('Here are the dropped files', files)
    console.log('Dropped at coordinates', pos.x, pos.y)
    console.log('Here is the raw FileList object if you need it:', fileList)
    console.log('Here is the list of directories:', directories)
